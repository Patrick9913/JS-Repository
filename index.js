...
// funcion constructora de profesores
...
const construirListaProfesores = () => {
    ...
    if (profesores.length === 0) {
        ...
        for (let i = 0; i < profesores.length; i++){
            ...
            <div class="d-flex justify-content-between align-items-center m-5">
                <img src="./images/lapiz-de-usuario-32.png" alt="">
                <p class="m-0" style="width: 250px;">${profesores[i].nombre} ${profesores[i].apellido}</p>
                <p class="m-0">${profesores[i].edad}</p>
                <p class="m-0">${profesores[i].dni}</p>
                <p class="m-0">${profesores[i].materia}</p>
                <div>
...
buttons.validarProfesor.onclick = () => {
...
buttons.actualizarProfesor.onclick = () => {
